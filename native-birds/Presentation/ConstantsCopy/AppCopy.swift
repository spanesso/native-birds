...
enum AppCopy {
    ...
    enum Splash {
        ...
        enum SplashViewCopy {
            static let title = "Native Birds"
            static let subTitle = "Listen to the world of birds"
        }
        
        enum RemoteConfig {
            static let missingKeysTitle = "Configuration Incomplete"
            static let missingKeysMessage = "Required keys from Remote Config are missing. Please verify your Firebase Remote Config configuration and try again."
        }
        
        enum Location {
            static let permissionRequiredTitle = "Location Permission Required"
            static let permissionRequiredMessage = "BirdSongs needs access to your location to show nearby birds. Please enable GPS permissions to continue."
        }
